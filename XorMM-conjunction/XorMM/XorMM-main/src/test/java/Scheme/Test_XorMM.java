...
public class Test_XorMM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Search key
        search_keys = new String[]{"key_s_27", "key_s_86"};

        //initialize a database
        try {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\周超然\\Desktop\\XorMM-conjunction\\XorMM\\XorMM-main\\Plaintext_10_5.txt")); // 请将此路径替换为您的txt文件路径
            String line;
